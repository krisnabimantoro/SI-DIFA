...
@Module({
  ...
  imports: [PosyanduKaderModule, AdminModule, PendataanIbkModule, InformasiEdukasiKaderModule, LowonganKaderModule, MonitoringIbkModule, JadwalPosyanduModule, PresensiIbkModule, PresensiKaderModule, ProfileModule],
})
